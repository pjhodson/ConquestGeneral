...
void main ()
{
  ...
  tmpvar_10 = ((dot (xlv_TEXCOORD1, lightDir_7) * 0.5) + 0.5);
  lowp vec3 tmpvar_11;
  tmpvar_11 = texture2D (_Ramp, vec2(tmpvar_10)).xyz;
  ramp_9 = tmpvar_11;
  c_8.xyz = (((tmpvar_2 * _LightColor0.xyz) * ramp_9) * 2.0);
  c_8.w = 0.0;
  c_1 = c_8;
...
#line 426
#line 383
mediump vec4 LightingToonRamp( in SurfaceOutput s, in mediump vec3 lightDir, in mediump float atten ) {
    #line 385
    mediump float d = ((dot( s.Normal, lightDir) * 0.5) + 0.5);
    mediump vec3 ramp = texture( _Ramp, vec2( d, d)).xyz;
    mediump vec4 c;
    c.xyz = (((s.Albedo * _LightColor0.xyz) * ramp) * (atten * 2.0));
    #line 389
    c.w = 0.0;
    return c;
}
...
void surf( in Input IN, inout SurfaceOutput o ) {
    mediump vec4 c = (texture( _MainTex, IN.uv_MainTex) * _Color);
    o.Albedo = c.xyz;
    #line 403
    o.Alpha = c.w;
}
...
void main ()
{
  ...
  c_1.xyz = (tmpvar_2 * ((8.0 * tmpvar_9.w) * tmpvar_9.xyz));
  c_1.w = tmpvar_3;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_17 = ((dot (xlv_TEXCOORD1, lightDir_13) * 0.5) + 0.5);
  lowp vec3 tmpvar_18;
  tmpvar_18 = texture2D (_Ramp, vec2(tmpvar_17)).xyz;
  ramp_16 = tmpvar_18;
  c_15.xyz = (((tmpvar_2 * _LightColor0.xyz) * ramp_16) * (atten_14 * 2.0));
  c_15.w = 0.0;
  c_1 = c_15;
  c_1.xyz = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  ramp_11 = tmpvar_13;
  c_10.xyz = (((tmpvar_2 * _LightColor0.xyz) * ramp_11) * (atten_9 * 2.0));
  c_10.w = 0.0;
  c_1 = c_10;
  c_1.xyz = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_9 = tmpvar_14;
  c_1.xyz = (tmpvar_2 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_9 * 2.0))));
  c_1.w = tmpvar_3;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = (tmpvar_2 * max (min (tmpvar_11, ((tmpvar_9.x * 2.0) * tmpvar_10.xyz)), (tmpvar_11 * tmpvar_9.x)));
  c_1.w = tmpvar_3;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_14 = ((dot (xlv_TEXCOORD1, lightDir_10) * 0.5) + 0.5);
  lowp vec3 tmpvar_15;
  tmpvar_15 = texture2D (_Ramp, vec2(tmpvar_14)).xyz;
  ramp_13 = tmpvar_15;
  c_12.xyz = (((tmpvar_2 * _LightColor0.xyz) * ramp_13) * (atten_11 * 2.0));
  c_12.w = 0.0;
  c_1 = c_12;
  c_1.xyz = (c_1.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  shadow_9 = tmpvar_11;
  c_1.xyz = (tmpvar_2 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((shadow_9 * 2.0))));
  c_1.w = tmpvar_3;
  gl_FragData[0] = c_1;
}
...
//   d3d11 - ALU: 4 to 10, TEX: 2 to 3, FLOW: 1 to 1
//   d3d11_9x - ALU: 4 to 10, TEX: 2 to 3, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecednninnbnicpihhgfdobccomemkkkfbjalabaaaaaamiacaaaaadaaaaaa
...
abaaaaaaaaaaaaaadcaaaaajbcaabaaaaaaaaaaaakaabaaaaaaaaaaaabeaaaaa
aaaaaadpabeaaaaaaaaaaadpefaaaaajpcaabaaaaaaaaaaaagaabaaaaaaaaaaa
...
egacbaaaabaaaaaaegiccaaaaaaaaaaaadaaaaaadiaaaaaihcaabaaaacaaaaaa
egacbaaaabaaaaaaegiccaaaaaaaaaaaabaaaaaadiaaaaahhcaabaaaaaaaaaaa
...
egbcbaaaadaaaaaaegacbaaaaaaaaaaadgaaaaaficcabaaaaaaaaaaaabeaaaaa
aaaaaaaadoaaaaab"
}
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecedomfneajglhaeghoehiglklhejobalbnbabaaaaaadaaeaaaaaeaaaaaa
daaaaaaajeabaaaaheadaaaapmadaaaaebgpgodjfmabaaaafmabaaaaaaacpppp
amabaaaafaaaaaaaadaacmaaaaaafaaaaaaafaaaacaaceaaaaaafaaaabaaaaaa
...

...
egbcbaaaacaaaaaaegiccaaaabaaaaaaaaaaaaaadcaaaaajbcaabaaaaaaaaaaa
akaabaaaaaaaaaaaabeaaaaaaaaaaadpabeaaaaaaaaaaadpefaaaaajpcaabaaa
aaaaaaaaagaabaaaaaaaaaaaeghobaaaabaaaaaaaagabaaaaaaaaaaaefaaaaaj
...
diaaaaahhcaabaaaaaaaaaaaegacbaaaaaaaaaaaegacbaaaacaaaaaaaaaaaaah
hcaabaaaaaaaaaaaegacbaaaaaaaaaaaegacbaaaaaaaaaaadcaaaaajhccabaaa
aaaaaaaaegacbaaaabaaaaaaegbcbaaaadaaaaaaegacbaaaaaaaaaaadgaaaaaf
...
SetTexture 2 [_Ramp] 2D 1
// 14 instructions, 3 temp regs, 0 temp arrays:
// ALU 7 float, 0 int, 0 uint
// TEX 3 (0 load, 0 comp, 0 bias, 0 grad)
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedbbpcchofimoghaldfjihdgpheckemmidabaaaaaageadaaaaadaaaaaa
...

...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1

...

...

...
lowp vec4 frag_surf( in v2f_surf IN ) {
    ...
    lowp vec4 c = LightingToonRamp( o, lightDir, (texture( _LightTexture0, vec2( dot( IN._LightCoord, IN._LightCoord))).w * 1.0));
    c.w = 0.0;
    return c;
}
in highp vec2 xlv_TEXCOORD0;
...
lowp vec4 frag_surf( in v2f_surf IN ) {
    ...
    lowp vec4 c = LightingToonRamp( o, lightDir, 1.0);
    c.w = 0.0;
    return c;
}
in highp vec2 xlv_TEXCOORD0;
...
void main ()
{
  ...
  tmpvar_18 = ((dot (xlv_TEXCOORD1, tmpvar_17) * 0.5) + 0.5);
  lowp vec3 tmpvar_19;
  tmpvar_19 = texture2D (_Ramp, vec2(tmpvar_18)).xyz;
  ramp_16 = tmpvar_19;
  c_15.xyz = (((tmpvar_3 * _LightColor0.xyz) * ramp_16) * (atten_14 * 2.0));
  c_15.w = 0.0;
  c_1.xyz = c_15.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
lowp vec4 frag_surf( in v2f_surf IN ) {
    ...
    #line 451
    lowp vec3 lightDir = normalize(IN.lightDir);
    lowp vec4 c = LightingToonRamp( o, lightDir, (((float((IN._LightCoord.z > 0.0)) * UnitySpotCookie( IN._LightCoord)) * UnitySpotAttenuate( IN._LightCoord.xyz)) * 1.0));
    c.w = 0.0;
    return c;
}
in highp vec2 xlv_TEXCOORD0;
...
lowp vec4 frag_surf( in v2f_surf IN ) {
    ...
    #line 443
    lowp vec3 lightDir = normalize(IN.lightDir);
    lowp vec4 c = LightingToonRamp( o, lightDir, ((texture( _LightTextureB0, vec2( dot( IN._LightCoord, IN._LightCoord))).w * texture( _LightTexture0, IN._LightCoord).w) * 1.0));
    c.w = 0.0;
    return c;
}
in highp vec2 xlv_TEXCOORD0;
...
void main ()
{
  ...
  tmpvar_13 = ((dot (xlv_TEXCOORD1, lightDir_9) * 0.5) + 0.5);
  lowp vec3 tmpvar_14;
  tmpvar_14 = texture2D (_Ramp, vec2(tmpvar_13)).xyz;
  ramp_12 = tmpvar_14;
  c_11.xyz = (((tmpvar_3 * _LightColor0.xyz) * ramp_12) * (atten_10 * 2.0));
  c_11.w = 0.0;
  c_1.xyz = c_11.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
lowp vec4 frag_surf( in v2f_surf IN ) {
    ...
    #line 441
    lowp vec3 lightDir = IN.lightDir;
    lowp vec4 c = LightingToonRamp( o, lightDir, (texture( _LightTexture0, IN._LightCoord).w * 1.0));
    c.w = 0.0;
    return c;
}
in highp vec2 xlv_TEXCOORD0;
...
//   d3d11 - ALU: 5 to 15, TEX: 2 to 4, FLOW: 1 to 1
//   d3d11_9x - ALU: 5 to 15, TEX: 2 to 4, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "POINT" }
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
feeffiedepepfceeaaklklklepfdeheocmaaaaaaabaaaaaaaiaaaaaacaaaaaaa
aaaaaaaaaaaaaaaaadaaaaaaaaaaaaaaapaaaaaafdfgfpfegbhcghgfheaaklkl
fdeieefchaacaaaaeaaaaaaajmaaaaaafjaaaaaeegiocaaaaaaaaaaaaiaaaaaa
...
aaaaaadpefaaaaajpcaabaaaaaaaaaaaagaabaaaaaaaaaaaeghobaaaacaaaaaa
...
aeaaaaaaefaaaaajpcaabaaaabaaaaaapgapbaaaaaaaaaaaeghobaaaabaaaaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1

...

...
bcaabaaaaaaaaaaaegbcbaaaacaaaaaaegacbaaaaaaaaaaadcaaaaajbcaabaaa
aaaaaaaaakaabaaaaaaaaaaaabeaaaaaaaaaaadpabeaaaaaaaaaaadpefaaaaaj
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecedilohgfdnbllfebidfphfaejnabhockpeabaaaaaaoeadaaaaaeaaaaaa
daaaaaaaiaabaaaaciadaaaalaadaaaaebgpgodjeiabaaaaeiabaaaaaaacpppp
aeabaaaaeeaaaaaaacaacmaaaaaaeeaaaaaaeeaaacaaceaaaaaaeeaaabaaaaaa
...

...

...
aaaaaaaaegacbaaaaaaaaaaaegacbaaaabaaaaaaaaaaaaahhccabaaaaaaaaaaa
...
SetTexture 3 [_Ramp] 2D 2
// 22 instructions, 2 temp regs, 0 temp arrays:
// ALU 14 float, 0 int, 1 uint
// TEX 4 (0 load, 0 comp, 0 bias, 0 grad)
// FLOW 1 static, 0 dynamic
"ps_4_0

...
baaaaaahbcaabaaaaaaaaaaaegbcbaaaacaaaaaaegacbaaaaaaaaaaadcaaaaaj
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1

...

...

...
abaaaaaaagaabaaaabaaaaaaeghobaaaacaaaaaaaagabaaaabaaaaaaapaaaaah
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1

...
abeaaaaaaaaaaadpefaaaaajpcaabaaaaaaaaaaaagaabaaaaaaaaaaaeghobaaa
adaaaaaaaagabaaaacaaaaaaefaaaaajpcaabaaaabaaaaaaegbabaaaabaaaaaa
...
eghobaaaacaaaaaaaagabaaaaaaaaaaaapaaaaahicaabaaaaaaaaaaaagaabaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedgkhgcefhlifljlffdemkjgfjajjeeblmabaaaaaabaadaaaaadaaaaaa
cmaaaaaammaaaaaaaaabaaaaejfdeheojiaaaaaaafaaaaaaaiaaaaaaiaaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaaimaaaaaaaaaaaaaaaaaaaaaa
...

...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecedmbdgeehjljhdegdjahlcnmohocblinieabaaaaaakaaeaaaaaeaaaaaa
daaaaaaalmabaaaammadaaaagmaeaaaaebgpgodjieabaaaaieabaaaaaaacpppp
...

